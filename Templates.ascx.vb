    ...
    Partial Class Templates
        ...
        Private Sub BindSelectedTheme()
            ...
            For Each file As String In System.IO.Directory.GetFiles(path)
                ...
                If file.EndsWith(Constants.TemplateName_EmailToAdmin) Then
                    txtEmailAdmin.Text = GetTemplate(drpThemes.SelectedItem.Value, Constants.TemplateName_EmailToAdmin, drpLocales.SelectedValue, True)
                End If
        ...
        Private Sub SaveTemplates(ByRef blnSucess As Boolean)
            ...
            If pnlTemplateName.Visible Then
                ...
                If String.IsNullOrEmpty(txtEmailAdmin.Text) Or String.IsNullOrEmpty(txtEmailUser.Text) Or String.IsNullOrEmpty(txtFormTemplate.Text) Then
